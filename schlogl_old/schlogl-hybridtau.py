...
'''
Generates [M] final-time realisations of Schlogl model with Hybrid tau up to time T=50, and saves as "schlogl-samples-HAT-[TSS]-[IS]-[M].[proc].npy" .
...
np.save(f'dat/schlogl-samples-HAT-{TSS}-{IS}-{M}.{proc}', save_arr)
